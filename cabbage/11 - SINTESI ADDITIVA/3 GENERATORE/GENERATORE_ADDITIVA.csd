<Cabbage>
    form caption("GENERATORE ADDITIVA") size(700, 400), guiMode("queue") pluginId("def1")
...
<CsoundSynthesizer>
    ...
    <CsInstruments>
        ...
        ;oscillatore
        iAmp = (1/i(gkDen))*(i(gkDen)/2) ;calcola l'ampiezza rispetto alla durata e densità degli eventi sonori
        iFreq = (i(gkFfond) * irndHarm)  + irndSpredFreq ;calcola la frequenza
        aSig oscili iAmp, iFreq; osclillatore
