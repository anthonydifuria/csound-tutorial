<Cabbage>
    ...
    form caption("ONDA TRIANGOLARE") size(400, 300), guiMode("queue") pluginId("def1")
...
<CsoundSynthesizer>
    ...
    instr 1 
        ...
        ;OSCILLATORI SINTESI ADDITIVA - SERIE ARMONICA - ONDA TRIANGOLARE
        ;ARMONICHE ONDA TRIANGOLARE = (I) + (II * 0) + (III / 3^2) + (IV * 0) + (V / 5^2)
        a1f oscili kamp / 1^2, 1 * kfreq ;FONDAMENTALE 1F 
