...
<CsoundSynthesizer>
    ...
    instr 1 
        ...
        ;OSCILLATORI SINTESI ADDITIVA - SERIE ARMONICA - ONDA QUADRA (armoniche dispari)
        ;ARMONICHE ONDA QUADRA = (I) + (II * 0) + (III / 3) + (IV * 0) + (V / 5)
        a1f oscili kamp / 1, 1 * kfreq ;FONDAMENTALE 1F 
        a2f oscili kamp * 0, 2 * kfreq ; 2F - AMPIEZZA = 0 
        a3f oscili kamp / 3, 3 * kfreq ; 3F
        a4f oscili kamp * 0, 4 * kfreq ; 4F - AMPIEZZA = 0 
