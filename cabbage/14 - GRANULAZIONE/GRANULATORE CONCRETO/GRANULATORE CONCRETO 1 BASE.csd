<Cabbage> bounds(0, 0, 0, 0)
    form caption("GRANULATORE SAMPLE BASE") size(850, 400), pluginId("def1"), colour("40,40,40,255")
    ...
    label bounds(370, 254, 102, 18) channel("label10025") text("ENVELOPE")
    combobox bounds(370, 276, 102, 20) channel("func"), text("Hanning", "Bartlett (Triangle)", "Gaussian")

    ;PAN
    rslider bounds(560, 242, 95, 70) channel("spreadpan") range(0, 1, 0, 1, 0.001) text("Spread Pan")

    ;RIVERBERAZIONE
    rslider bounds(660, 246, 60, 60) channel("rev") range(0, 1, 0, 1, 0.001) text("REVERB")
    rslider bounds(722, 246, 60, 60) channel("room") range(0, 0.999, 0, 1, 0.001) text("ROOM")
