<Cabbage> bounds(0, 0, 0, 0)
    form caption("GRANULATORE SINTETICO 2") size(620, 320), guiMode("queue") pluginId("def1") colour("40,40,40,255")
    ...
    ;SERIE GEOMETRICA
    rslider bounds(292, 140, 65, 60) channel("num") range(1, 10, 3, 1, 1) text("NUM")
    rslider bounds(362, 140, 65, 60) channel("deno") range(1, 10, 2, 1, 1) text("DEN")
    rslider bounds(432, 140, 65, 60) channel("geo") range(1, 6, 1, 1, 1) text("GEOMETRICA")
    rslider bounds(502, 140, 103, 60) channel("spazioFreqGeo") range(0, 1, 1, 1, 0.01) text("GEO SPAZIO FREQ")
...
<CsoundSynthesizer>
    ...
    <CsInstruments>
        ...
        instr 2
            ...
            iFreq = (i(gkFfond) + irndSpredFreq) * irndHarm * irndGeo
