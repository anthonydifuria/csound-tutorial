<Cabbage>
form caption("SUBTRACTIVE GENERATOR") size(700, 400), guiMode("queue") pluginId("def1")
...
;FILTER
iAmp = (1/i(gkDen))*(i(gkDen)) * 5 ;computes the amplitude with respect to the duration and density of the sound events
