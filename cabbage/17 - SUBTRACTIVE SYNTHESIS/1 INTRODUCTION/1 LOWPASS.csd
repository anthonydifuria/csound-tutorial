<Cabbage>
form caption("Subtractive Low Pass") size(400, 300), guiMode("queue") pluginId("def1")
...
kfreqLowPass cabbageGetValue "freqLowPass"; Controls the cutoff frequency

aPinkNoise pinker ; Pink noise generator
aOut butterlp aPinkNoise, kfreqLowPass ;Low Pass filter
