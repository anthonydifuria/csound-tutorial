<Cabbage> bounds(0, 0, 0, 0)
    form caption("SYNTHETIC GRANULATOR 2") size(620, 320), guiMode("queue") pluginId("def1") colour("40,40,40,255")
    ...
    rslider bounds(432, 140, 65, 60) channel("geo") range(1, 6, 1, 1, 1) text("GEOMETRIC")
    rslider bounds(502, 140, 103, 60) channel("spazioFreqGeo") range(0, 1, 1, 1, 0.01) text("GEO FREQ SPACING")
