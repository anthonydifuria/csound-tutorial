<Cabbage> bounds(0, 0, 0, 0)
    form caption("SYNTHETIC GRANULATOR") size(800, 450), guiMode("queue") pluginId("def1") colour("40,40,40,255")

    groupbox bounds(4, 6, 705, 99) channel("PARAMETRI FONDAMENTALI") text("FUNDAMENTAL PARAMETERS"){
    ...
    ;HARMONIC SERIES
    rslider bounds(10, 25, 65, 60), channel("harm"), range(1, 6, 1, 1, 1), text("HARMONIC")
    rslider bounds(78, 25, 106, 60) channel("spazioFreqArm") range(0, 1, 1, 1, 0.01) text("HARM FREQ SPACING")
    ...
    rslider bounds(420, 25, 65, 60) channel("geo") range(1, 6, 1, 1, 1) text("GEOMETRIC")
    rslider bounds(492, 25, 103, 60) channel("spazioFreqGeo") range(0, 1, 1, 1, 0.01) text("GEO FREQ SPACING")
    }

    groupbox bounds(6, 214, 500, 99) channel("modulazioni") text("MODULATIONS"){
