<Cabbage>
    form caption("GENERATORE FM") size(700, 400), guiMode("queue") pluginId("def1")
    ...
    rslider bounds(440, 110, 100, 100), channel("FMdev"), range(0, 1000, 1, 1, 0.1), text("FM DEV"), trackerColour(0, 255, 0, 255), outlineColour(0, 0, 0, 50), textColour(0, 0, 0, 255)
    rslider bounds(550, 110, 100, 100), channel("FMmod"), range(0.1, 500, 0, 1, 0.1), text("FM MOD"), trackerColour(0, 255, 0, 255), outlineColour(0, 0, 0, 50), textColour(0, 0, 0, 255)
...
<CsoundSynthesizer>
    ...
    <CsInstruments>
        ...
        instr 2
            ...
            ;SEGNALE PORTANTE                                                        
            aSigFM oscili (1/i(gkDen))*(i(gkDen)/2), ((i(gkFfond) * irndHarm)  + irndSpredFreq ) + aFM_DevMod
