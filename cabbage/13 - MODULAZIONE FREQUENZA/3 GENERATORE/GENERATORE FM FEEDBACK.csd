<Cabbage>
    form caption("GENERATORE FM FEEDBACK") size(700, 400), guiMode("queue") pluginId("def1")
    ...
    rslider bounds(110, 10, 100, 100), channel("den"), range(1, 100, 4, 1, 0.01), text("DEN"), trackerColour(0, 255, 0, 255), outlineColour(0, 0, 0, 50), textColour(0, 0, 0, 255)
    rslider bounds(220, 10, 100, 100), channel("ffond"), range(20, 4000, 300, 1, 0.01), text("FREQ FOND"), trackerColour(0, 255, 0, 255), outlineColour(0, 0, 0, 50), textColour(0, 0, 0, 255)
    ...
    rslider bounds(440, 10, 100, 100), channel("harm"), range(1, 10, 1, 1, 1), text("ARMONICHE"), trackerColour(0, 255, 0, 255), outlineColour(0, 0, 0, 50), textColour(0, 0, 0, 255)
    ...
    rslider bounds(440, 110, 100, 100), channel("FMindex"), range(0, 10, 1, 1, 0.1), text("FM INDEX"), trackerColour(0, 255, 0, 255), outlineColour(0, 0, 0, 50), textColour(0, 0, 0, 255)
    rslider bounds(550, 110, 100, 100), channel("FMmod"), range(0, 500, 0, 1, 0.1), text("FM MOD"), trackerColour(0, 255, 0, 255), outlineColour(0, 0, 0, 50), textColour(0, 0, 0, 255)
...
<CsoundSynthesizer>
    ...
    <CsInstruments>
        ...
        instr 1
            ...
            gkModindex cabbageGetValue "FMindex"
            gkFMmod cabbageGetValue "FMmod"
        ...
        instr 2
            ...
            ;SEGNALE PORTANTE                                                        
            aSigFM oscili (1/i(gkDen))*(i(gkDen)/2), (((i(gkFfond) + irndSpredFreq + aFM_FeedBack) * irndHarm) ) 
            ;AUTO MODULAZIONE 
            aFM_FeedBack = aSigFM * i(gkFMdev)
