...
<CsoundSynthesizer>
    ...
    instr 1 
        ...
        ;ADDITIVE SYNTHESIS OSCILLATORS - HARMONIC SERIES - SQUARE WAVE (odd harmonics)
        ;SQUARE WAVE HARMONICS = (I) + (II * 0) + (III / 3) + (IV * 0) + (V / 5)
        a1f oscili kamp / 1, 1 * kfreq ;FUNDAMENTAL 1F 
        a2f oscili kamp * 0, 2 * kfreq ; 2F - AMPLITUDE = 0 
        a3f oscili kamp / 3, 3 * kfreq ; 3F
        a4f oscili kamp * 0, 4 * kfreq ; 4F - AMPLITUDE = 0 
