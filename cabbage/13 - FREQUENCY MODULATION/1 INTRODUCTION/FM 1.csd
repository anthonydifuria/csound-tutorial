<Cabbage>
    form caption("FM 1") size(400, 300), guiMode("queue") pluginId("def1")

    rslider bounds(296, 162, 100, 100), channel("gain"), range(0, 1, 0, 1, 0.01), text("Gain"), trackerColour("lime"), outlineColour(0, 0, 0, 50), textColour("black")
    ...
    rslider bounds(130, 36, 100, 100), channel("FreqDev"), range(0, 500, 0, 1, 0.01), text("Freq DEV"), trackerColour(0, 255, 0, 255), outlineColour(0, 0, 0, 50), textColour(0, 0, 0, 255)
