<Cabbage>
    form caption("FM GENERATOR FEEDBACK") size(700, 400), guiMode("queue") pluginId("def1")
    ...
    rslider bounds(220, 10, 100, 100), channel("ffond"), range(20, 4000, 300, 1, 0.01), text("FUND FREQ"), trackerColour(0, 255, 0, 255), outlineColour(0, 0, 0, 50), textColour(0, 0, 0, 255)
    ...
    rslider bounds(440, 10, 100, 100), channel("harm"), range(1, 10, 1, 1, 1), text("HARMONICS"), trackerColour(0, 255, 0, 255), outlineColour(0, 0, 0, 50), textColour(0, 0, 0, 255)
