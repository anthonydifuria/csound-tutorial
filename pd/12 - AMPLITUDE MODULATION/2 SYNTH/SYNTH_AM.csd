...
massign 0, 1 ; all MIDI channels -> instr 1 (the MIDI keyboard of the Cabbage version)
        ...
        opcode SynthAdd, aaaaa, kkkkkkkkk
             ...
             ka1, ka2, ka3, ka4, ka5, kvelocity, kFreq, kFreqShift, kPitchShift  xin           
                ...
                aSig1 oscili ka1 * kvelocity, ((kFreq * 1) * kPitchShift) + kFreqShift   ;FUNDAMENTAL
        ...
        instr 2 
            ...
            gkAMampMod chnget "AMampMod"
            gkAMfreqMod chnget "AMfreqMod"
        ...
        instr 1
            ...
            aSum = ((a1+a2+a3+a4+a5) / 5 );carrier signal

            aAmpMod oscili gkAMampMod, gkAMfreqMod;modulator signal

            aSumRM = aSum * aAmpMod;ring modulation

            aSumAM = (aSumRM + aSum) * aEnv;amplitude modulation and multiply by envelope 
